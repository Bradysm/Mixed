...
public class MainActivity extends AppCompatActivity {
    ...
    private BluetoothGattCallback callback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Toast.makeText(getApplicationContext(), "Service discovery failed with status: " + status, Toast.LENGTH_SHORT).show();
            }
            ...
            if (!gatt.setCharacteristicNotification(rx, true)) {
                Toast.makeText(getApplicationContext(), "Couldn't set notifications for RX characteristic!", Toast.LENGTH_SHORT).show();
            }
            ...
            if (rx.getDescriptor(CLIENT_UUID) != null) {
                ...
                if (!gatt.writeDescriptor(desc)) {
                    makeToast("Couldn't write RX client descriptor value!");
                }
            } else {
                makeToast("Couldn't get RX client descriptor!");
            }
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            makeToast("Received: " + characteristic.getStringValue(0));
        }
    };
    ...
    private LeScanCallback scanCallback = new LeScanCallback() {
        ...
        public void onLeScan(BluetoothDevice bluetoothDevice, int i, byte[] bytes) {
            makeToast("Found device: " + bluetoothDevice.getAddress());
            // Check if the device has the UART service.
            if (parseUUIDs(bytes).contains(UART_UUID)) {
                // Found a device, stop the scan.
                adapter.stopLeScan(scanCallback);
                makeToast("Found UART service!");
    ...
    /**
     * this will make a toast on the screen passing the String of what is needed to be said
     * @param toast
     */
